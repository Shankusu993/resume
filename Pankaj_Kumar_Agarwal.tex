...
%       {Computer Science and Engg. (M.Tech Dual 5Y);  CGPA 8.07/10.0}{July 2018 -- June 2023}
...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{BugTracker}
      {Ongoing Software Engineering term project, as a part of which I am working to build a Bug Tracker which is powered by Django as it's backend framework.}
  \resumeSubHeadingListEnd
